...
var geodataCall = $.ajax({
    type: 'GET',
    dataType: 'json',
    url: 'data/salvador.json',
});

var dataCall = $.ajax({
    type: 'GET',
    dataType: 'json',
    url: 'https://proxy.hxlstandard.org/data.json?strip-headers=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F13B-nk4TFOyA5cw3kgkxUIynXcWD2KAEDqx54CjxhkEs%2Fedit%23gid%3D1491388007&force=on'
});
